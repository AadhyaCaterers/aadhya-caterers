...
// Floating WhatsApp + scroll-to-top + mobile sticky bar — luxury palette
export default function FloatingButtons() {
  return (
    <>
      ...
      {/* Mobile sticky bottom bar — gold/red/maroon, NO black */}
      <div className="mobile-sticky">
        <a
          ...
          style={{
            ...
            color: '#FFFBF2', textAlign: 'center', textDecoration: 'none',
            fontFamily: '"DM Sans", sans-serif', fontWeight: 700,
            fontSize: '0.78rem', letterSpacing: '0.10em', textTransform: 'uppercase',
        ...
        <Link
          ...
          style={{
            ...
            color: '#3B2A1F', textAlign: 'center', textDecoration: 'none',
            fontFamily: '"DM Sans", sans-serif', fontWeight: 700,
            fontSize: '0.78rem', letterSpacing: '0.10em', textTransform: 'uppercase',
            display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2,
          }}
