...
const SectionHeading = ({ kicker, title, center = false, dark = false }) => (
  <div style={{ textAlign: center ? 'center' : 'left', marginBottom: 22 }}>
    ...
    <h2 className="section-title" style={{ fontSize: 'clamp(1.6rem,3vw,2.4rem)', marginTop: 4, marginBottom: 8, lineHeight: 1.25, color: dark ? '#8a6508' : undefined }}>
      {title}
    </h2>
    {center
      ? <Ornament />
      : <div className="gold-divider-left" style={{ background: dark ? 'linear-gradient(90deg,#8a6508,transparent)' : undefined }} />
    }
  </div>
);
...
export default function About() {
  return (
    <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 60, alignItems: 'center' }}>
            <FadeIn x={-40}>
              <div style={{ position: 'relative', paddingBottom: 40 }}>
                <div style={{ position: 'relative', borderRadius: 4, overflow: 'hidden', border: '3px solid rgba(212,160,23,0.5)', boxShadow: '0 18px 42px rgba(58,36,6,0.18)' }}>
                ...
                <div style={{
                  ...
                  color: '#1a0e02', padding: '14px 22px',
                  fontFamily: '"Playfair Display", serif', fontWeight: 700, fontSize: '0.9rem',
                  textAlign: 'center', boxShadow: '0 8px 22px rgba(138,101,8,0.35)', borderRadius: 2,
                }}>
            ...
            <FadeIn x={40} delay={0.15}>
              ...
              <p style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.15rem', lineHeight: 1.85, marginBottom: 16 }}>
              ...
              <p style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.08rem', lineHeight: 1.8, marginBottom: 16 }}>
                We have catered over <strong style={{ color: '#8a6508' }}>500+ events</strong> across Hyderabad and Telangana — from intimate house warmings to 1500-guest grand weddings — and served more than <strong style={{ color: '#8a6508' }}>10,000 happy guests</strong> with authentic Telugu Saapadu, royal buffet feasts and theatrical live counters.
              </p>
      ...
      <section style={{ background: '#0e0700', borderTop: '1px solid rgba(212,160,23,0.2)', borderBottom: '1px solid rgba(212,160,23,0.2)', padding: '70px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 30, textAlign: 'center' }}>
          {[
            ...
            <FadeUp key={s.label}>
              ...
              <div style={{ fontFamily: '"Cormorant Garamond", serif', color: 'rgba(253,246,227,0.7)', fontSize: '0.95rem', letterSpacing: '0.14em', marginTop: 6, textTransform: 'uppercase' }}>{s.label}</div>
            </FadeUp>
          ))}
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 50, alignItems: 'center' }}>
            <FadeIn x={-30}>
              ...
              <p style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.12rem', color: 'rgba(253,246,227,0.85)', lineHeight: 1.85, marginBottom: 16 }}>
            ...
            <FadeIn x={30} delay={0.15}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <img src="/img5.jpg" alt="Traditional Telugu meal"  style={{ width: '100%', height: 230, objectFit: 'cover', border: '1px solid rgba(212,160,23,0.35)', borderRadius: 2 }} />
                <img src="/img6.jpg" alt="Banana leaf service"        style={{ width: '100%', height: 230, objectFit: 'cover', border: '1px solid rgba(212,160,23,0.35)', borderRadius: 2, marginTop: 28 }} />
                <img src="/img3.jpg" alt="Live cooking traditional"   style={{ width: '100%', height: 230, objectFit: 'cover', border: '1px solid rgba(212,160,23,0.35)', borderRadius: 2, marginTop: -28 }} />
                <img src="/img2.jpg" alt="Festival feast layout"      style={{ width: '100%', height: 230, objectFit: 'cover', border: '1px solid rgba(212,160,23,0.35)', borderRadius: 2 }} />
              </div>
            </FadeIn>
          </div>
        </div>
            ...
            {PILLARS.map((p, i) => (
              <FadeUp key={p.title} delay={i * 0.06}>
                <div className="cream-card" style={{ padding: '32px 26px', borderRadius: 4, height: '100%' }}>
                  ...
                  <h3 style={{ fontFamily: '"Playfair Display", serif', color: '#8a6508', fontSize: '1.2rem', marginBottom: 10 }}>{p.title}</h3>
                  <div style={{ width: 36, height: 1, background: 'rgba(138,101,8,0.4)', marginBottom: 12 }} />
                  <p style={{ fontFamily: '"Lato", sans-serif', fontSize: '0.92rem', color: 'rgba(58,36,6,0.78)', lineHeight: 1.7 }}>{p.desc}</p>
                </div>
              </FadeUp>
            ))}
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 50, alignItems: 'center' }}>
            <FadeIn x={-30}>
              <div style={{ position: 'relative' }}>
                <img src="/img7.jpg" alt="Grand wedding catering" style={{ width: '100%', height: 480, objectFit: 'cover', borderRadius: 2, border: '2px solid rgba(212,160,23,0.35)' }} />
                <div style={{ position: 'absolute', bottom: 16, left: 16, background: 'rgba(26,14,2,0.9)', padding: '14px 22px', border: '1px solid rgba(212,160,23,0.4)', borderRadius: 2 }}>
                  <p style={{ fontFamily: '"Great Vibes"', color: '#d4a017', fontSize: '1.6rem', lineHeight: 1 }}>Grand Weddings</p>
                  <p style={{ fontFamily: '"Lato"', color: 'rgba(253,246,227,0.7)', fontSize: '0.78rem', letterSpacing: '0.15em', textTransform: 'uppercase', marginTop: 2 }}>500 – 1500 Guests</p>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(to bottom, #1a0e02, #0e0700)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 36 }}>
          <FadeUp>
            <div className="gold-card" style={{ padding: 0, borderRadius: 4, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '28px 30px' }}>
                <h3 style={{ fontFamily: '"Playfair Display", serif', color: '#d4a017', fontSize: '1.35rem', marginBottom: 10 }}>Royal Buffet Setup</h3>
                <div style={{ width: 40, height: 1, background: 'rgba(212,160,23,0.5)', marginBottom: 12 }} />
                <p style={{ fontFamily: '"Lato", sans-serif', color: 'rgba(253,246,227,0.82)', fontSize: '0.95rem', lineHeight: 1.75 }}>
          ...
          <FadeUp delay={0.15}>
            <div className="gold-card" style={{ padding: 0, borderRadius: 4, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '28px 30px' }}>
                <h3 style={{ fontFamily: '"Playfair Display", serif', color: '#d4a017', fontSize: '1.35rem', marginBottom: 10 }}>Live Counters</h3>
                <div style={{ width: 40, height: 1, background: 'rgba(212,160,23,0.5)', marginBottom: 12 }} />
                <p style={{ fontFamily: '"Lato", sans-serif', color: 'rgba(253,246,227,0.82)', fontSize: '0.95rem', lineHeight: 1.75 }}>
