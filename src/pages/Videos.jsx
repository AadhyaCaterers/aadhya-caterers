  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 68, height: 68, borderRadius: '50%', background: 'rgba(212,160,23,0.96)', color: '#1a0e02', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 26px rgba(212,160,23,0.55)', fontSize: '1.4rem', paddingLeft: 4 }}>
          ▶
        </div>
      </div>
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '22px 18px 18px' }}>
        ...
        <p style={{ fontFamily: '"Lato"', color: 'rgba(253,246,227,0.78)', fontSize: '0.78rem', lineHeight: 1.5 }}>{video.desc}</p>
      </div>
    </motion.button>
  );
}
      ...
      <section className="section-pad" style={{ background: '#1a0e02', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
          <FadeUp style={{ textAlign: 'center', marginBottom: 50 }}>
            ...
            <Ornament />
            <p style={{ fontFamily: '"Cormorant Garamond"', color: 'rgba(253,246,227,0.85)', fontSize: '1.1rem', maxWidth: 720, margin: '14px auto 0', lineHeight: 1.7 }}>
        ...
        {active && (
          ...
          >
            ...
            <button
              onClick={() => setActive(null)}
              aria-label="Close"
              style={{ position: 'absolute', top: 20, right: 24, background: 'rgba(212,160,23,0.95)', border: 'none', color: '#1a0e02', width: 42, height: 42, fontSize: '1.1rem', cursor: 'pointer', borderRadius: '50%', fontWeight: 700 }}
            >✕</button>
          </motion.div>
        )}
      </AnimatePresence>
