...
export default function Menu() {
  ...
  return (
    <>
      ...
      <section className="section-pad pattern-overlay" style={{ background: 'linear-gradient(to bottom, #1a0e02, #0e0700 60%, #1a0e02)' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 24px' }}>
          ...
          <FadeUp style={{ textAlign: 'center', marginBottom: 30 }}>
            ...
            <Ornament />
            <p className="section-subtitle" style={{ marginTop: 16, fontFamily: '"Cormorant Garamond"', fontSize: '1.1rem', maxWidth: 720, marginInline: 'auto', lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 16, flexWrap: 'wrap', marginBottom: 56 }}>
            {[
              ...
              >
                <h3 style={{ color: '#d4a017', fontSize: '1.9rem', marginBottom: 6, fontFamily: '"Playfair Display"', fontWeight: 700 }}>{num}</h3>
                <p style={{ color: 'rgba(253,246,227,0.75)', fontSize: '0.82rem', letterSpacing: '0.12em', textTransform: 'uppercase', fontFamily: '"Lato"' }}>{text}</p>
              </div>
            ))}
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h3 style={{ fontFamily: '"Playfair Display"', color: '#d4a017', fontSize: '1.7rem', marginBottom: 10 }}>
                {cat.icon} {cat.name}
              </h3>
              <div className="ornament-divider" style={{ maxWidth: 200 }}>
                <span className="ornament-symbol">✦</span>
              </div>
              <p style={{ fontFamily: '"Cormorant Garamond"', color: 'rgba(253,246,227,0.82)', fontSize: '1.08rem', maxWidth: 720, margin: '0 auto', lineHeight: 1.7 }}>
                {cat.desc}
              </p>
            </motion.div>
          </AnimatePresence>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                    <div style={{
                      ...
                      fontSize: '1rem', color: '#1a0e02', fontWeight: 700, flexShrink: 0,
                      boxShadow: '0 4px 12px rgba(212,160,23,0.3)',
                    }}>
                      ✦
                    </div>
                    <div style={{ flex: 1 }}>
                      <h4 style={{ color: '#fdf6e3', fontSize: '1.02rem', marginBottom: 3, fontFamily: '"Cormorant Garamond"', fontWeight: 600 }}>{item}</h4>
                      <p style={{ color: 'rgba(253,246,227,0.6)', fontSize: '0.78rem', fontFamily: '"Lato"' }}>Premium quality preparation</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div style={{ textAlign: 'center', marginTop: 70 }}>
            <p style={{ fontFamily: '"Cormorant Garamond"', color: 'rgba(253,246,227,0.85)', fontSize: '1.1rem', marginBottom: 26, maxWidth: 700, margin: '0 auto 26px', lineHeight: 1.7 }}>
